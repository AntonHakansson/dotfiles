...
with lib.my; {
  ...
  config = {
    ...
    home-manager = {
      ...
      # files easily to my $HOME, but 'home-manager.users.hakanssn.home.file.*'
      # is much too long and harder to maintain, so I've made aliases in:
      #
      #   home.file        ->  home-manager.users.hakanssn.home.file
      #   home.configFile  ->  home-manager.users.hakanssn.home.xdg.configFile
      #   home.dataFile    ->  home-manager.users.hakanssn.home.xdg.dataFile
